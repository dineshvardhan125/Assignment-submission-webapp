...
export default function GradeForm({ submission, totalMarks }: GradeFormProps) {
    ...
    const handleGrade = async (e: React.FormEvent) => {
        ...
        if (Number(marks) > totalMarks) {
            toast.error(`Marks cannot exceed total marks (${totalMarks}). Please enter ${totalMarks} or below.`);
            return;
        }
